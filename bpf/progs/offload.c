...
DEFINE_BPF_PROG_KVER(schedcls, tether_downstream6_ether, 5_4, AID_NETWORK_STACK, KVER_5_4)
(struct __sk_buff* skb) {
    return do_forward6(skb, ETHER, DOWNSTREAM, KVER_5_4);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_upstream6_ether, 5_4, AID_NETWORK_STACK, KVER_5_4)
(struct __sk_buff* skb) {
...
DEFINE_BPF_PROG_KVER(schedcls, tether_downstream6_rawip, 5_4, AID_NETWORK_STACK, KVER_5_4)
(struct __sk_buff* skb) {
    return do_forward6(skb, RAWIP, DOWNSTREAM, KVER_5_4);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_upstream6_rawip, 5_4, AID_NETWORK_STACK, KVER_5_4)
(struct __sk_buff* skb) {
    return do_forward6(skb, RAWIP, UPSTREAM, KVER_5_4);
}

// and for 4.14/4.19 kernels
DEFINE_BPF_PROG_KVER_RANGE(schedcls, tether_downstream6_rawip, 4_14, AID_NETWORK_STACK,
                           KVER_4_14, KVER_5_4)
(struct __sk_buff* skb) {
    return do_forward6(skb, RAWIP, DOWNSTREAM, KVER_4_14);
}

DEFINE_BPF_PROG_KVER_RANGE(schedcls, tether_upstream6_rawip, 4_14, AID_NETWORK_STACK,
                           KVER_4_14, KVER_5_4)
(struct __sk_buff* skb) {
...
DEFINE_BPF_PROG_KVER(schedcls, tether_downstream4_rawip, 5_10, AID_NETWORK_STACK, KVER_5_10)
(struct __sk_buff* skb) {
    return do_forward4(skb, RAWIP, DOWNSTREAM, UPDATETIME, KVER_5_10);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_upstream4_rawip, 5_10, AID_NETWORK_STACK, KVER_5_10)
(struct __sk_buff* skb) {
    return do_forward4(skb, RAWIP, UPSTREAM, UPDATETIME, KVER_5_10);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_downstream4_ether, 5_10, AID_NETWORK_STACK, KVER_5_10)
(struct __sk_buff* skb) {
    return do_forward4(skb, ETHER, DOWNSTREAM, UPDATETIME, KVER_5_10);
}

DEFINE_BPF_PROG_KVER(schedcls, tether_upstream4_ether, 5_10, AID_NETWORK_STACK, KVER_5_10)
(struct __sk_buff* skb) {
...
DEFINE_OPTIONAL_BPF_PROG_KVER_RANGE(schedcls, tether_downstream4_rawip, opt54,
                                    AID_NETWORK_STACK, KVER_5_4, KVER_5_10)
(struct __sk_buff* skb) {
...
DEFINE_OPTIONAL_BPF_PROG_KVER_RANGE(schedcls, tether_downstream4_rawip, opt,
                                    AID_NETWORK_STACK, KVER_4_14, KVER_5_4)
(struct __sk_buff* skb) {
...
DEFINE_BPF_PROG_KVER_RANGE(schedcls, tether_downstream4_rawip, 5_4, AID_NETWORK_STACK,
                           KVER_5_4, KVER_5_10)
(struct __sk_buff* skb) {
    return do_forward4(skb, RAWIP, DOWNSTREAM, NO_UPDATETIME, KVER_5_4);
}

DEFINE_BPF_PROG_KVER_RANGE(schedcls, tether_upstream4_rawip, 5_4, AID_NETWORK_STACK,
                           KVER_5_4, KVER_5_10)
(struct __sk_buff* skb) {
...
DEFINE_BPF_PROG_KVER_RANGE(schedcls, tether_downstream4_ether, 4_14, AID_NETWORK_STACK,
                           KVER_4_14, KVER_5_10)
(struct __sk_buff* skb) {
    return do_forward4(skb, ETHER, DOWNSTREAM, NO_UPDATETIME, KVER_4_14);
}

DEFINE_BPF_PROG_KVER_RANGE(schedcls, tether_upstream4_ether, 4_14, AID_NETWORK_STACK,
                           KVER_4_14, KVER_5_10)
(struct __sk_buff* skb) {
